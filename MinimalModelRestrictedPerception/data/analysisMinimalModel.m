...
load('L35N40gamma1TimeSocialRestricted.mat')
timeSocialGamma1 = time90percentEatenSocial;
load('L35N40gamma2TimeSocialRestricted.mat')
timeSocialGamma2 = time90percentEatenSocial;
load('L35N40gamma3TimeSocialRestricted.mat')
timeSocialGamma3 = time90percentEatenSocial;

load('L35N40gamma0TimeSolitaryRestricted.mat')
timeSolitaryGamma0 = time90percentEatenSolitary;
load('L35N40gamma1TimeSolitaryRestricted.mat')
timeSolitaryGamma1 = time90percentEatenSolitary;
load('L35N40gamma2TimeSolitaryRestricted.mat')
timeSolitaryGamma2 = time90percentEatenSolitary;
load('L35N40gamma3TimeSolitaryRestricted.mat')
...
meansTimeSocial(3) = mean(timeSocialGamma2);
meansTimeSocial(4) = mean(timeSocialGamma3);

stdTimeSocial(1) = std(timeSocialGamma0);
stdTimeSocial(2) = std(timeSocialGamma1);
stdTimeSocial(3) = std(timeSocialGamma2);
stdTimeSocial(4) = std(timeSocialGamma3);

meansTimeSolitary(1) = mean(timeSolitaryGamma0);
meansTimeSolitary(2) = mean(timeSolitaryGamma1);
meansTimeSolitary(3) = mean(timeSolitaryGamma2);
meansTimeSolitary(4) = mean(timeSolitaryGamma3);


stdTimeSolitary(1) = std(timeSolitaryGamma0);
stdTimeSolitary(2) = std(timeSolitaryGamma1);
stdTimeSolitary(3) = std(timeSolitaryGamma2);
stdTimeSolitary(4) = std(timeSolitaryGamma3);
...
% social, gamma 0
load('L35N40gamma0StepsSocialRestricted.mat')
...
% social, gamma 1
load('L35N40gamma1StepsSocialRestricted.mat')
...
% social, gamma 2
load('L35N40gamma2StepsSocialRestricted.mat')
...
% social, gamma 3 
load('L35N40gamma3StepsSocialRestricted.mat')
...
% solitary, gamma 0
load('L35N40gamma0StepsSolitaryRestricted.mat')
...
% solitary, gamma 1
load('L35N40gamma1StepsSolitaryRestricted.mat')
...
% solitary, gamma 2
load('L35N40gamma2StepsSolitaryRestricted.mat')
...
% solitary, gamma 3
load('L35N40gamma3StepsSolitaryRestricted.mat')
