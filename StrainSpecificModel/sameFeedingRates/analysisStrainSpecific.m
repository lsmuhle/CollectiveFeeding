%% reset
clear;
%% calculate means of needed time until 90 % of food is eaten for npr-1 and N2 worms and plot results

% load data and save variables
load('L35N40patch1TimeNpr1.mat')
timeNpr1patch1 = time90percentEatenNpr1;
load('L35N40patch2TimeNpr1.mat')
timeNpr1patch2 = time90percentEatenNpr1;
load('L35N40patch4TimeNpr1.mat')
timeNpr1patch4 = time90percentEatenNpr1;

load('L35N40patch1TimeN2.mat')
timeN2patch1 = time90percentEatenN2;
load('L35N40patch2TimeN2.mat')
timeN2patch2 = time90percentEatenN2;
load('L35N40patch4TimeN2.mat')
...
load('L35N40patch1IndividuallyEatenFUsNpr1.mat')
...
load('L35N40patch2IndividuallyEatenFUsNpr1.mat')
...
load('L35N40patch4IndividuallyEatenFUsNpr1.mat')
...
load('L35N40patch1IndividuallyEatenFUsN2.mat')
...
load('L35N40patch2IndividuallyEatenFUsN2.mat')
...
load('L35N40patch4IndividuallyEatenFUsN2.mat')
...
hNpr1(1) = histogram(FUsPerNpr1WormPatch1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
hold on
hNpr1(2) = histogram(FUsPerNpr1WormPatch2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','k');
hNpr1(3) = histogram(FUsPerNpr1WormPatch4,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
...
figure('pos',[0 0 1240 1748]);
hN2(1) = histogram(FUsPerN2WormPatch1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
hold on
hN2(2) = histogram(FUsPerN2WormPatch2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','k');
hN2(3) = histogram(FUsPerN2WormPatch4,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
...
%one food patch
figure('pos',[0 0 1240 1748]);
hCombined1(1) = histogram(FUsPerNpr1WormPatch1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
hold on
hCombined1(2) = histogram(FUsPerN2WormPatch1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
...
% two food patches
figure('pos',[0 0 1240 1748]);
hCombined2(1) = histogram(FUsPerNpr1WormPatch2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
hold on
hCombined2(2) = histogram(FUsPerN2WormPatch2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
...
% four food patches
figure('pos',[0 0 1240 1748]);
hCombined4(1) = histogram(FUsPerNpr1WormPatch4,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
hold on
hCombined4(2) = histogram(FUsPerN2WormPatch4,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
...
load('L35N40patch1StepsNpr1.mat')
...
load('L35N40patch2StepsNpr1.mat')
...
load('L35N40patch4StepsNpr1.mat')
...
efficienciesNpr1patch1 = FUsNpr1EffPatch1./summedStepsNpr1patch1;
efficienciesNpr1patch2 = FUsNpr1EffPatch2./summedStepsNpr1patch2;
efficienciesNpr1patch4 = FUsNpr1EffPatch4./summedStepsNpr1patch4;
efficienciesN2patch1 = FUsN2EffPatch1./summedStepsN2patch1;
efficienciesN2patch2 = FUsN2EffPatch2./summedStepsN2patch2;
efficienciesN2patch4 = FUsN2EffPatch4./summedStepsN2patch4;
