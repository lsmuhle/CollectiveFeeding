...
gammaValues = [0 1 1.5 2 3 4 5 6 8 10];
...
for gammaCtr = 1:ngamma
    ...
    % load data
    load(['L35N40gamma' num2str(gamma) 'Npr1DifferentFeedingRatesGamma.mat'])
    load(['L35N40gamma' num2str(gamma) 'N2DifferentFeedingRatesGamma.mat'])
...
axis([0 max(gammaValues) 0 1.5e4])
...
savefig("feeding_times_strain_specific_feedingrates_gamma")
