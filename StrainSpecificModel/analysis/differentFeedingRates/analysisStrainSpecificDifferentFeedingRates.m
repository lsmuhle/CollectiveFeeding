...
meansTimeNpr1(1) = nanmean(timeNpr1patch1)*deltaT;
meansTimeNpr1(2) = nanmean(timeNpr1patch2)*deltaT;
meansTimeNpr1(3) = nanmean(timeNpr1patch4)*deltaT;

stdTimeNpr1(1) = nanstd(timeNpr1patch1)*deltaT;
stdTimeNpr1(2) = nanstd(timeNpr1patch2)*deltaT;
stdTimeNpr1(3) = nanstd(timeNpr1patch4)*deltaT;
% disp(['N = ' num2str(nnz(~isnan(timeNpr1patch1))) ' for npr-1 at 1 patches'])
% disp(['N = ' num2str(nnz(~isnan(timeNpr1patch2))) ' for npr-1 at 2 patches'])
% disp(['N = ' num2str(nnz(~isnan(timeNpr1patch4))) ' for npr-1 at 4 patches'])

meansTimeN2(1) = nanmean(timeN2patch1)*deltaT;
meansTimeN2(2) = nanmean(timeN2patch2)*deltaT;
meansTimeN2(3) = nanmean(timeN2patch4)*deltaT;

stdTimeN2(1) = nanstd(timeN2patch1)*deltaT;
stdTimeN2(2) = nanstd(timeN2patch2)*deltaT;
stdTimeN2(3) = nanstd(timeN2patch4)*deltaT;
...
savefig("feeding_times_strain_specific_feedingrates")
...
hNpr1(1) = histogram(FUsPerNpr1WormPatch1*relativeFeedingRateNpr1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
hold on
hNpr1(2) = histogram(FUsPerNpr1WormPatch2*relativeFeedingRateNpr1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','k');
hNpr1(3) = histogram(FUsPerNpr1WormPatch4*relativeFeedingRateNpr1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
legend(hNpr1,'one food patch','two food patches','four food patches');
hNpr1(1).LineWidth = 6;
hNpr1(2).LineWidth = 6;
hNpr1(3).LineWidth = 6;
ax = gca;
...
savefig("feeding_units_strain_specific_feedingrates_np1")
...
figure('pos',[0 0 1240 1748]);
hN2(1) = histogram(FUsPerN2WormPatch1*relativeFeedingRateN2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
hold on
hN2(2) = histogram(FUsPerN2WormPatch2*relativeFeedingRateN2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','k');
hN2(3) = histogram(FUsPerN2WormPatch4*relativeFeedingRateN2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
legend(hN2,'one food patch','two food patches','four food patches');
hN2(1).LineWidth = 6;
hN2(2).LineWidth = 6;
hN2(3).LineWidth = 6;
ax = gca;
...
savefig("feeding_units_strain_specific_feedingrates_N2")

%% plot histograms with number of ingested food units of npr-1 and N2 worms in each food environment

edges = 0:10:500; 

%one food patch
figure('pos',[0 0 1240 1748]);
hCombined1(1) = histogram(FUsPerNpr1WormPatch1*relativeFeedingRateNpr1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
hold on
hCombined1(2) = histogram(FUsPerN2WormPatch1*relativeFeedingRateN2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
legend(hCombined1,'npr-1','N2');
hCombined1(1).LineWidth = 6;
hCombined1(2).LineWidth = 6;
ax = gca;
ax.FontSize = 42;
ax.LineWidth = 5;
% ylim([0 0.10])
...
lgd.LineWidth = 6;
lgd.FontSize = 60;
title('one food patch')
box off
savefig("feeding_units_strain_specific_feedingrates_1patch")

% two food patches
figure('pos',[0 0 1240 1748]);
hCombined2(1) = histogram(FUsPerNpr1WormPatch2*relativeFeedingRateNpr1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
hold on
hCombined2(2) = histogram(FUsPerN2WormPatch2*relativeFeedingRateN2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
legend(hCombined2,'npr-1','N2');
hCombined2(1).LineWidth = 6;
hCombined2(2).LineWidth = 6;
ax = gca;
ax.FontSize = 42;
ax.LineWidth = 5;
% ylim([0 0.10])
...
lgd.LineWidth = 6;
lgd.FontSize = 40;
title('two food patches')
box off
savefig("feeding_units_strain_specific_feedingrates_2patch")

% four food patches
figure('pos',[0 0 1240 1748]);
hCombined4(1) = histogram(FUsPerNpr1WormPatch4*relativeFeedingRateNpr1,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','b');
hold on
hCombined4(2) = histogram(FUsPerN2WormPatch4*relativeFeedingRateN2,'BinEdges',edges,'Normalization','probability','DisplayStyle','stairs','EdgeColor','r');
legend(hCombined4,'npr-1','N2');
hCombined4(1).LineWidth = 6;
hCombined4(2).LineWidth = 6;
ax = gca;
ax.FontSize = 42;
ax.LineWidth = 5;
% ylim([0 0.10])
...
efficienciesNpr1patch1 = FUsNpr1EffPatch1*relativeFeedingRateNpr1./summedStepsNpr1patch1;
efficienciesNpr1patch2 = FUsNpr1EffPatch2*relativeFeedingRateNpr1./summedStepsNpr1patch2;
efficienciesNpr1patch4 = FUsNpr1EffPatch4*relativeFeedingRateNpr1./summedStepsNpr1patch4;
efficienciesN2patch1 = FUsN2EffPatch1*relativeFeedingRateN2./summedStepsN2patch1;
efficienciesN2patch2 = FUsN2EffPatch2*relativeFeedingRateN2./summedStepsN2patch2;
efficienciesN2patch4 = FUsN2EffPatch4*relativeFeedingRateN2./summedStepsN2patch4;
...
lgd.FontSize = 40;
box off
savefig("feeding_efficiencies_strain_specific_feedingrates_npr1")
...
lgd.FontSize = 40;
box off
savefig("feeding_efficiencies_strain_specific_feedingrates_N2")
