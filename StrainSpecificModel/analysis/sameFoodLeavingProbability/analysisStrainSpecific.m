...
load('L35N40timeNpr1patch1SameLeaving.mat')
timeNpr1patch1 = time90percentEatenNpr1;
load('L35N40timeNpr1patch2SameLeaving.mat')
timeNpr1patch2 = time90percentEatenNpr1;
load('L35N40timeNpr1patch4SameLeaving.mat')
timeNpr1patch4 = time90percentEatenNpr1;

load('L35N40timeN2patch1SameLeaving.mat')
timeN2patch1 = time90percentEatenN2;
load('L35N40timeN2patch2SameLeaving.mat')
timeN2patch2 = time90percentEatenN2;
load('L35N40timeN2patch4SameLeaving.mat')
...
load('L35N40IndividuallyEatenFUsNpr1patch1SameLeaving.mat')
...
load('L35N40IndividuallyEatenFUsNpr1patch2SameLeaving.mat')
...
load('L35N40IndividuallyEatenFUsNpr1patch4SameLeaving.mat')
...
load('L35N40IndividuallyEatenFUsN2patch1SameLeaving.mat')
...
load('L35N40IndividuallyEatenFUsN2patch2SameLeaving.mat')
...
load('L35N40IndividuallyEatenFUsN2patch4SameLeaving.mat')
...
load('L35N40stepsNpr1patch1SameLeaving.mat')
...
load('L35N40stepsNpr1patch2SameLeaving.mat')
...
load('L35N40stepsNpr1patch4SameLeaving.mat')
...
% N2, one food patch
load('L35N40stepsN2patch1SameLeaving.mat')
...
% N2, two food patches
load('L35N40stepsN2patch2SameLeaving.mat')
...
load('L35N40stepsN2patch4SameLeaving.mat')
